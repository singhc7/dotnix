...
# I shouldn't manually edit this file! It was auto-generated by ‘nixos-generate-config’
# and it will likely get overwritten the next time I run that tool. I need to make sure
# any custom configuration changes are made in my configuration.nix file instead.
